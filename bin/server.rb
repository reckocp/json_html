...
module App
  ...
  def App.tasks
    # This is an example
    @all_tasks ||= [
      { message: "Walk the dog", field: completed, id: 1},
      { message: "Go to the grocery store", field: completed, id: 2},
      { message: "Pay the bills", field: completed, id: 3},
      { message: "Do homework", field: completed, id: 4},
    ]
  end
end
system('clear')
